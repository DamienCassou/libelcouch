* libelcouch
  ...
  #+BEGIN_HTML
      <p>
        ...
        <a href="https://github.com/DamienCassou/libelcouch/actions/workflows/test.yml">
          <img alt="pipeline status" src="https://github.com/DamienCassou/libelcouch/actions/workflows/test.yml/badge.svg" />
        </a>
      </p>
  #+END_HTML
...
Get libelcouch from [[https://melpa.org/#/libelcouch][melpa]] or [[https://stable.melpa.org/#/libelcouch][melpa stable]]. You can also clone the git
repository.
